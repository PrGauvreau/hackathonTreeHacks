...
var Environment = (function () {
    ...
    Object.defineProperty(Environment.prototype, "rc", {
        get: function () {
            ...
            return this.deserializeRCs(this.localRC, this.globalFrameworkRC, this.config.localRCPath, this.config.globalRCPath);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Environment.prototype.deleteIfExist = function (serviceIds) {
        ...
        serviceIds.forEach(function (id) {
            ...
            var globalTarget = Object.keys(_this.globalFrameworkRC.targets || {}).find(function (name) { return _this.globalFrameworkRC.targets[name].split('/')[1] === id; });
            if (globalTarget) {
                delete _this.globalFrameworkRC[globalTarget];
            }
        });
    };
    /**
    ...
    Environment.prototype.migrateOldFormat = function () {
        var migrator = new EnvironmentMigrator_1.EnvironmentMigrator(this.config.home, this.out);
        migrator.migrate();
    ...
    Environment.prototype.saveGlobalRC = function () {
        var file = this.serializeRC(__assign({}, this.globalRC, { 'graphcool-framework': this.globalFrameworkRC }));
