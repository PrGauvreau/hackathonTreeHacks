        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3: return [4 /*yield*/, this.plugins.findTopic(cmd)];
                    case 4:
                        topic = _a.sent();
                    ...
                    case 7:
                        subtopics = _a.sent();
                        if (!(subtopics && subtopics.length)) return [3 /*break*/, 9];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.out
                            .log("\nGraphQL Backend Development Framework & Platform (" + chalk_1.default.underline('https://www.graph.cool') + ")\n    \n" + chalk_1.default.bold('Usage:') + " " + chalk_1.default.bold('graphcool') + " COMMAND");
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            //   debugger
                                            // }
                                            return [2 /*return*/, cmds.map(function (cmd) {
                    ...
                    case 4:
                        ...
                        this.out.log("\nUse " + chalk_1.default.green('graphcool-framework help [command]') + " for more information about a command.\nDocs can be found here:\nhttps://www.graph.cool/docs/reference/graphcool-cli/commands-aiteerae6l\n\n" + chalk_1.default.dim('Examples:') + "\n\n" + chalk_1.default.gray('-') + " Initialize files for a new Graphcool service\n  " + chalk_1.default.green('$ graphcool-framework init') + "\n\n" + chalk_1.default.gray('-') + " Deploy service changes (or new service)\n  " + chalk_1.default.green('$ graphcool-framework deploy') + "\n");
                        return [2 /*return*/];
                }
            });
        });
