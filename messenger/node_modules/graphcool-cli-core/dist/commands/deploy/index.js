...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.help = "\n  \n  " + chalk_1.default.green.bold('Examples:') + "\n      \n" + chalk_1.default.gray('-') + " Deploy local service definition changes to the default stage.\n  " + chalk_1.default.green('$ graphcool-framework deploy') + "\n\n" + chalk_1.default.gray('-') + " Deploy local changes to a specific stage called `prod`\n  " + chalk_1.default.green('$ graphcool-framework deploy --stage prod') + "\n    \n" + chalk_1.default.gray('-') + " Deploy local changes to a specific stage called `prod`, accepting potential data loss caused by schema changes\n  " + chalk_1.default.green('$ graphcool-framework deploy --stage production --force') + "\n  ";
    Deploy.flags = {
